  ...
  return (
    <>
      <div className={styles.container}>
        <Slider imageCount={urls.length} isClick={isClick} slides={slides} slider={slider} selectedIndex={selectedIndex} firstCellInSlide={firstCellInSlide} sliderX={sliderX} sliderVelocity={sliderVelocity}>
          {
            urls.map((url, index) => {
