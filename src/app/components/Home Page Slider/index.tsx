...
import { useState, useEffect, useRef, createRef, useLayoutEffect, useCallback, useMemo, Dispatch, SetStateAction } from "react";
...
export default function SliderWrapper({ urls, showFullscreenSlider, setShowFullscreenSlider }: Props) {
